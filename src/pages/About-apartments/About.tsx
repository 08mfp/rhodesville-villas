...
const AboutApartments: React.FC = () => (
    <div className="bg-gray-50 dark:bg-gray-800 p-4 md:p-8">
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-8 text-center">Rhodesville Apartments</h1>
        <p className="text-xl md:text-3xl text-gray-700 dark:text-gray-300 mb-8 text-center">Modern Comfort and Convenience for Everyday Living</p>
...
export default AboutApartments;
