        ...
        <div className="max-w-screen-xl mx-auto px-4">
            <div className="sm:flex sm:items-center sm:justify-between">
                <div className="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                    ...
                    <span className="self-center text-2xl md:text-3xl font-semibold whitespace-nowrap dark:text-white">Rhodesville</span>
                </div>
            ...
            <span className="block text-sm md:text-base text-gray-500 sm:text-center dark:text-gray-400">© 2024 Rhodesville Villas. All rights reserved.</span>
            <br/>
            ...
            intellectual property rights, affiliate relationships, and that information provided is not professional or medical advice, 
            with jurisdiction governed by The Republic of Zambia, as detailed in our full policies accessible via links. If at any point you require more information or need want to report a copyright infringement, you can contact the web dev team.</i></span>            
        </div>
    </footer>
);
